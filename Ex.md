...
```html
        Пример кода взят откуда-то из неизвесного мне источника)
...
Это встроенная [ссылка с title элементом на страницу GeekBrains "Наведите на это сообщение"](https://gb.ru/ "Я посхвлка, нажми на меня"). Это — [без title тут нет посхалки)](https://gb.ru/).
...
> не работает(  хотя уверен что правильно оформил

Картинка без `alt` текста

![mycode.jpg](//mycode.jpg/150x100)

Картинка с альтом и тайтлом:

![mycode.jpg](//mycode.jpg/300x300 "Можно задать title")
...
[image1]: //mycode.jpg/250x100
[image2]: //mycode.jpg/200x100
[image3]: //mycode.jpg/150x100

Картинки-ссылки:

[![Alt text](//mycode.jpg/150x100)](https://gb.ru/)
